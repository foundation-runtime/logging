 ...
 * 
 */
public final class CABLoggingHostPatternConverter extends LoggingEventPatternConverter {
	 ...
	 *            options, may be null.
	 */
	private CABLoggingHostPatternConverter() {
		super("Host", "host");
	 ...
	 */
	public static CABLoggingHostPatternConverter newInstance(final String[] options) {
		return new CABLoggingHostPatternConverter();
	}
