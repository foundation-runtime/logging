...
import com.cisco.vss.foundation.logging.ApplicationState;
 ...
 * @author Yair Ogen
 */
public class CABRollEventListener implements FileRollEventListener {
	
	public void onFileRoll(final FileRollEvent fileRollEvent) {

//		CABLogger.printLoggersInfo(LOGGER);
