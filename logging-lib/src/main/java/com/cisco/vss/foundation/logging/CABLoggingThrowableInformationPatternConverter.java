 ...
 * 
 */
public final class CABLoggingThrowableInformationPatternConverter extends LoggingEventPatternConverter {
	/**
	 ...
	 *            options, may be null.
	 */
	private CABLoggingThrowableInformationPatternConverter(final String[] options) {
	 ...
	 */
	public static CABLoggingThrowableInformationPatternConverter newInstance(final String[] options) {
		return new CABLoggingThrowableInformationPatternConverter(options);
	}
