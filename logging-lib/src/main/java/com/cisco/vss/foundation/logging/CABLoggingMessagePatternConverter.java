 ...
 * 
 */
public final class CABLoggingMessagePatternConverter extends LoggingEventPatternConverter {
	 ...
	 * Private constructor.
	 */
	private CABLoggingMessagePatternConverter(final String[] options) {
	 ...
	 */
	public static CABLoggingMessagePatternConverter newInstance(final String[] options) {
		return new CABLoggingMessagePatternConverter(options);
	}
