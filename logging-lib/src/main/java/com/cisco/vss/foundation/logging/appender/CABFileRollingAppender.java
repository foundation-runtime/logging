 ...
 */
public class CABFileRollingAppender extends FileAppender {
	 ...
	 */
	public CABFileRollingAppender(final Layout layout, final String filename) throws IOException {
		this();
	 ...
	 * @throws java.io.IOException
	 */
	public CABFileRollingAppender(final Layout layout, final String filename, final boolean append) throws IOException {
		this();
	 ...
	 * @throws java.io.IOException
	 */
	public CABFileRollingAppender(final Layout layout, final String filename, final boolean append, final boolean bufferedIO, final int bufferSize) throws IOException {
		this();
	...
	protected final void subAppend(final LoggingEvent event) {
		if (event instanceof ScheduledFileRollEvent) {
			...
			if(event instanceof CabLoggingEvent){
				...
				cabLoggingEvent.setAppenderName(this.getName());
			}
