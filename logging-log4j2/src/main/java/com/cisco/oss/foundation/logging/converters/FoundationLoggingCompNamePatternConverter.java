 ...
 * 
 */
@Plugin(name = "FoundationLoggingCompNamePatternConverter", category = "Converter")
@ConverterKeys({ "compName" })
public final class FoundationLoggingCompNamePatternConverter  extends NamePatternConverter {
	 ...
	 * 
	 */
	private FoundationLoggingCompNamePatternConverter(final String[] options) {
		super("CompName", "compName",options);
	...
	public static FoundationLoggingCompNamePatternConverter newInstance(final String[] options) {
		return new FoundationLoggingCompNamePatternConverter(options);
	}
