 ...
 * 
 */
@Plugin(name = "FoundationLoggingCompInstPathPatternConverter", category = "Converter")
@ConverterKeys({ "compInstallPath" })
public final class FoundationLoggingCompInstPathPatternConverter  extends NamePatternConverter {
	 ...
	 * 
	 */
	private FoundationLoggingCompInstPathPatternConverter(final String[] options) {
		super("CompInstallPath", "compInstallPath",options);
	...
	public static FoundationLoggingCompInstPathPatternConverter newInstance(final String[] options) {
		return new FoundationLoggingCompInstPathPatternConverter(options);
	}
